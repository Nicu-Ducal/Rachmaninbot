...
JOIN_ALREADY_IN_VOICE_CHAT = "I am already in your voice channel"
...
SONG_NOT_FOUND_DESCRIPTION = "Sorry, I could not find the given song, try using the search command."
...
PAUSED_ALREADY = "The song is already paused"
RESUMED_ALREADY = "The song is currently playing"